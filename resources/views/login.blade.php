...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="{{URL::asset('public/fonts/material-icon/css/material-design-iconic-font.min.css')}}">
        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    <figure><img src="{{ URL::asset ('images/signin-image.png') }}" alt="sing up image"></figure>
